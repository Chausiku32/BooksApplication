...
public class APIUtil {
    ...
    public static final String API_KEY = "AIzaSyAUGiDGd4LuiNHY6rj6HwB1zzyyWvbMbW4";
    ...
    public static URL baseUrl(String title)
    {
    ...
    public static URL baseUrl(String title, String author, String publisher, String isbn){
        URL url = null;
